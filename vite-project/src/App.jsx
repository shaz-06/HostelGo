    ...
    <div style={{ background: "#f9fafb", minHeight: "100vh", fontFamily: "Inter, system-ui, sans-serif" }}>
      ...
      {showCart && (
        ...
        >
          ...
          <div style={{ flexGrow: 1, overflowY: "auto" }}>
            {Object.keys(cart).length === 0 && (
              <div style={{ textAlign: "center", marginTop: "100px" }}>
                <h2 style={{ fontSize: "20px", fontWeight: "700", color: "#1f2937" }}>Your cart is empty 🛒</h2>
                <p style={{ color: "#6b7280", marginTop: "8px", fontSize: "14px" }}>Add some products</p>
              </div>
            )}
            ...
            {Object.values(cart).map(({ product, quantity }) => (
              ...
              >
                ...
                <div style={{ flexGrow: 1 }}>
                  ...
                  <p style={{ fontSize: "11px", color: "#6b7280", margin: "2px 0 4px 0" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "16px", marginTop: "6px" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                      ...
                      <span style={{ fontSize: "13px", fontWeight: "700", color: "#1f2937" }}>{quantity}</span>
                      <button
                        onClick={() => {
                    ...
                    <button
                      onClick={() => {
                        setCart((prev) => {
                          const newCart = { ...prev };
                          delete newCart[getCartKey(product)];
                          return newCart;
                        });
                      }}
                      style={{
          ...
          {(() => {
            const FREE_DELIVERY_THRESHOLD = 99;
            const deliveryFee = totalPrice >= FREE_DELIVERY_THRESHOLD ? 0 : (totalPrice > 0 ? 20 : 0);
            ...
            return Object.values(cart).length > 0 && (
              <div style={{ borderTop: "1px solid #f3f4f6", paddingTop: "16px", marginTop: "16px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", fontSize: "14px", color: "#4b5563", marginBottom: "8px" }}>
                  ...
                  <span style={{ fontWeight: "600", color: "#1f2937" }}>₹{totalPrice}</span>
                </div>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", fontSize: "14px", color: "#4b5563", marginBottom: "8px" }}>
                  ...
                  {deliveryFee === 0 ? (
                    <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                      <span style={{ textDecoration: "line-through", color: "#9CA3AF", fontSize: "14px" }}>₹20</span>
                ...
                <div style={{ marginBottom: "12px" }}>
                  {totalPrice >= FREE_DELIVERY_THRESHOLD ? (
                    <p style={{ color: "green", fontWeight: "700", fontSize: "13px", margin: "4px 0" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", fontSize: "18px", fontWeight: "800", color: "#1f2937", marginBottom: "16px", borderTop: "1px solid #eee", paddingTop: "12px" }}>
                  <span>Total</span>
