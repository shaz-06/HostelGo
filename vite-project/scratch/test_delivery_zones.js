...
import DeliveryServiceZone from "../backend/models/DeliveryServiceZone.js";
import UnserviceableRequest from "../backend/models/UnserviceableRequest.js";
...
async function runTests() {
  console.log("=== RUNNING DELIVERY ZONES INTEGRATION TESTS ===");
  try {
